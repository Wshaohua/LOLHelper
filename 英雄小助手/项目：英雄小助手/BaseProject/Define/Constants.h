...
/** 导航栏颜色 */
#define KNaviTintColor          [UIColor colorWithRed:25/255.0 green:30/255.0 blue:40/255.0 alpha:1.0]
/** TabBar颜色 */
#define KTabBarTintColor        [UIColor colorWithRed:25/255.0 green:30/255.0 blue:40/255.0 alpha:1.0]
//通过RGB设置颜色
